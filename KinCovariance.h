...
public:
    ...
    TMatrixD Interpolate(int sector, double p, double theta, double phi)
    {
        ...
        // Theta resolution
        Cov_Matrix[1][1] = _C_theta_hist.Interpolate(P_in_vector, Theta_in_vector, Phi_in_vector);
        // Phi resolution
        Cov_Matrix[2][2] = _C_phi_hist.Interpolate(P_in_vector, Theta_in_vector, Phi_in_vector);

        // Off Diagonal terms
        // Momentum/Theta covariance
        Cov_Matrix[0][1] = _C_P_theta_hist.Interpolate(P_in_vector, Theta_in_vector, Phi_in_vector);
        Cov_Matrix[1][0] = Cov_Matrix[0][1];

        // Momentum/Phi covariance
        Cov_Matrix[0][2] = _C_P_phi_hist.Interpolate(P_in_vector, Theta_in_vector, Phi_in_vector);
