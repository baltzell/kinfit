#ifndef KinConstraint_3C_h
#define KinConstraint_3C_h

#include "KinConstraint.h"

class KinConstraint_3C : public KinConstraint
{
public:

    KinConstraint_3C(std::vector<int> index_in_parts)
    {
    ...
    TMatrixD getDfDx(int idx_part, std::vector<TLorentzVector> init_particles, std::vector<TLorentzVector> fin_particles) override 
    {
        ...
        double data[_nconstraints][_nvars] = {
